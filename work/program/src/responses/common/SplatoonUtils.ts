...
export namespace Utils {
	...
	export async function getEmbedScheduleByTime(params: CallbackParams, title: string, battleType: Battle.Types, date: Date): Promise<void> {
		return await getEmbedSchedule(params, title, battleType, (info: ScheduleInfo[]) => {
			let index = -1;
	...
	export async function getEmbedScheduleNextRule(params: CallbackParams, title: string, battleType: Battle.Types, rule: Rule.Types): Promise<void> {
		return await getEmbedSchedule(params, title, battleType, (info: ScheduleInfo[]) => {
			let index = -1;
	...
	export async function getEmbedScheduleNext(params: CallbackParams, title: string, battleType: Battle.Types): Promise<void> {
		return await getEmbedSchedule(params, title, battleType, (info: ScheduleInfo[]) => {
			return 1;
		});
	}
	...
	export async function getEmbedScheduleNow(params: CallbackParams, title: string, battleType: Battle.Types): Promise<void> {
		return await getEmbedSchedule(params, title, battleType, (info: ScheduleInfo[]) => {
			return 0;
		});
	}

	export async function getEmbedSchedule(params: CallbackParams, title: string, battleType: Battle.Types, scheduleSelectorFunc: (info: ScheduleInfo[]) => number) : Promise<void> {
