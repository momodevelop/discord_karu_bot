...
class cResponse extends cResponseBase_1.cResponseBase {
    ...
    exec(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (rule == null) {
                let title = "(ﾉ≧∇≦)ﾉ ﾐ The next Ranked Battle is...!";
                yield SplatoonHelper_1.SplatoonHelper.SplatoonNextAnyProc(params, title, this.battleType);
            }
            else {
                let title = "(ﾉ≧∇≦)ﾉ ﾐ The next Ranked " + SplatoonHelper_1.SplatoonHelper.RULES_NAME[rule] + " is...!";
...
//# sourceMappingURL=17_splatoon-gachi-next.js.map