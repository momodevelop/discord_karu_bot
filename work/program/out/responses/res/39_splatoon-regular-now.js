...
class cResponse extends cResponseBase_1.cResponseBase {
    constructor() {
        ...
        this.title = "(ﾉ≧∇≦)ﾉ ﾐ TURF!!!";
        this.conditions = [
            SplatoonHelper_1.SplatoonHelper.CONDITION_BATTLE_TYPE[SplatoonHelper_1.eBattleTypes.REGULAR]
        ];
    }
    exec(params) {
...
//# sourceMappingURL=39_splatoon-regular-now.js.map